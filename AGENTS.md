...
- Agent-readable markdown twins, `llms.txt`, and `llms-full.txt` are post-build artifacts generated by `verificationdesign/scripts/build-md-twins.mjs` and verified independently by `verificationdesign/scripts/check-md-twins.mjs`; never hand-edit them.
